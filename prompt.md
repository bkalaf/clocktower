...
Fill out CreateRoomForm.tsx in the same way we did LoginForm.tsx, RegisterForm.tsx, and ForgotPasswordForm.tsx using Modal.tsx, Form.tsx, and FormControl.tsx as primitives. When submitted this form should CREATE_ROOM on the server.