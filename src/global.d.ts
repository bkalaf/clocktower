...
export * from './shared/personality';

declare global {
    /**
     * 1 = most chaotic/evil vibe, 5 = most lawful/good vibe
     * (Applied per-dimension with dimension-appropriate wording.)
     */
    export type PersonalityScore = 1 | 2 | 3 | 4 | 5;
