// src/components/ui/sidebar-right.tsx
'use client';
...
function RightSidebarProvider({
    ...
    React.useEffect(() => {
        const handleKeyDown = (event: KeyboardEvent) => {
            if (event.key === RIGHT_SIDEBAR_KEYBOARD_SHORTCUT && (event.metaKey || event.ctrlKey)) {
...
function RightSidebar({
    ...
    const { isMobile, state, openMobile, setOpenMobile, open } = useRightSidebar();
...
function RightSidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
...
function RightSidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
    return (
        <main
...
function RightSidebarInput({ className, ...props }: React.ComponentProps<typeof Input>) {
    return (
        <Input
...
function RightSidebarSeparator({ className, ...props }: React.ComponentProps<typeof Separator>) {
    return (
        <Separator
...
function RightSidebarMenuBadge({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
...
function RightSidebarMenuSubItem({ className, ...props }: React.ComponentProps<'li'>) {
    return (
        <li
